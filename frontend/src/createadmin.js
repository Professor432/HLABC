...
const CreateAdmin = () => {
  ...
  const handleUpdate = async (index, userEmail) => {
    const newRole = roleUpdates[index];
    if (!newRole) return;
              ...
              <tbody>
                {userData.map((entry, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <select
                        value={roleUpdates[index] || entry.role}
                    ...
                    <td>
                      <button onClick={() => handleUpdate(index, entry.email)}>Update</button>
                    </td>
                  </tr>
                ))}
              </tbody>
